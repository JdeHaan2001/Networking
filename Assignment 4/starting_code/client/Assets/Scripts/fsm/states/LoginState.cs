...
public class LoginState : ApplicationStateWithView<LoginView>
{
    ...
    public override void EnterState()
    {
        ...
        {
            List<string> names = new List<string> { "Pergu", "Korgulg", "Xaguk", "Rodagog", "Kodagog", "Dular", "Buggug", "Gruumsh", "LEEROY JENKINS" };
    ...
    private void handlePlayerJoinResponse(PlayerJoinResponse pMessage)
    {
        ...
        {
            view.TextConnectResults = "Username was already taken";
        }
    }
